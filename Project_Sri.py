...
acc=cross_val_score(estimator=ada,X=X_train,y=y_train,cv=10)
acc.mean()
...
from sklearn.model_selection import cross_val_score
acc=cross_val_score(estimator=gbc,X=X_train,y=y_train,cv=10)
acc.mean()
...
from sklearn.model_selection import cross_val_score
acc=cross_val_score(estimator=xgb,X=X_train,y=y_train,cv=10)
acc.mean()